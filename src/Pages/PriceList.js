    ...
    <Table className={tableclasses.table}>
      <TableHead className={tableclasses.tableHead}>
        <TableRow >
          ...
          <TableCell className={tableclasses.customHeadName}>Rate</TableCell>
          <TableCell className={tableclasses.customHeadName}>Report Category</TableCell>
