  ...
  <div className={tableclasses.body}>
    <div  className={tableclasses.header}>
      <div className={tableclasses.name}>
        ...
        <div  className={tableclasses.specification}>10 available report group</div>
      </div>
      <div>
    ...
    <div>
      ...
      <Button className={tableclasses.filterButton2}>Report group</Button>
      <Button className={tableclasses.filterButton2}>Alphabets</Button>
    ...
    <div className={tableclasses.filterButtonHori}>
      ...
      <Button className={tableclasses.filterButtonh3}>Layout</Button>
    </div>
    ...
    <Table className={tableclasses.table}>
      <TableHead className={tableclasses.tableHead}>
        <TableRow >
          <TableCell className={tableclasses.customHeadName}>Report ID</TableCell>
          <TableCell className={tableclasses.customHeadName}>Report name</TableCell>
